...
func NewServer(cfg *config.Config, authManager *auth.Manager, accessManager *sdkaccess.Manager, configFilePath string, opts ...ServerOption) *Server {
	...
	s := &Server{
		engine:              engine,
		handlers:            handlers.NewBaseAPIHandlersWithConfig(cfg, authManager),
		cfg:                 cfg,
...
func (s *Server) registerManagementRoutes() {
	...
	mgmt.Use(s.managementAvailabilityMiddleware(), s.mgmt.Middleware())
	{
		...
		mgmt.GET("/profiles", s.mgmt.GetProfiles)
		mgmt.PUT("/profiles", s.mgmt.PutProfiles)
		mgmt.PATCH("/profiles", s.mgmt.PatchProfile)
		mgmt.DELETE("/profiles", s.mgmt.DeleteProfile)
		mgmt.GET("/mcp-servers", s.mgmt.GetMCPServers)
		mgmt.PUT("/mcp-servers", s.mgmt.PutMCPServers)
		mgmt.PATCH("/mcp-servers", s.mgmt.PatchMCPServer)
		mgmt.DELETE("/mcp-servers", s.mgmt.DeleteMCPServer)
		mgmt.GET("/tool-mappings", s.mgmt.GetToolMappings)
		mgmt.PUT("/tool-mappings", s.mgmt.PutToolMappings)
		mgmt.PATCH("/tool-mappings", s.mgmt.PatchToolMapping)
		mgmt.DELETE("/tool-mappings", s.mgmt.DeleteToolMapping)
