...
func GetAntigravityModelConfig() map[string]*AntigravityModelConfig {
	return map[string]*AntigravityModelConfig{
		...
		"gemini-3-pro":               {Thinking: &ThinkingSupport{Min: 128, Max: 32768, ZeroAllowed: false, DynamicAllowed: true, Levels: []string{"low", "high"}}},
		"gemini-3-pro-low":           {Thinking: &ThinkingSupport{Min: 128, Max: 32768, ZeroAllowed: false, DynamicAllowed: true}},
		"claude-sonnet-4-5-thinking": {Thinking: &ThinkingSupport{Min: 1024, Max: 128000, ZeroAllowed: true, DynamicAllowed: true}, MaxCompletionTokens: 64000},
		"claude-opus-4-5-thinking":   {Thinking: &ThinkingSupport{Min: 1024, Max: 128000, ZeroAllowed: true, DynamicAllowed: true}, MaxCompletionTokens: 64000},
		"claude-sonnet-4-5":          {MaxCompletionTokens: 64000},
		"claude-3-5-sonnet-20241022": {MaxCompletionTokens: 8192},
		"claude-3-5-haiku-20241022":  {MaxCompletionTokens: 8192},
		"claude-3-opus-20240229":     {MaxCompletionTokens: 4096},
		"claude-3-sonnet-20240229":   {MaxCompletionTokens: 4096},
		"claude-3-haiku-20240307":    {MaxCompletionTokens: 4096},
		"gpt-oss-120b-medium":        {},
